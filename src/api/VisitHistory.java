 ...
 */
@WebServlet("/history")
public class VisitHistory extends HttpServlet {//需要check以下重复信息（需要修改的）
		...
		try {
			...
			if (request.getParameterMap().containsKey("user_id")) {
				...
				for (String id : visited_business_id) {
					array.put(connection.getRestaurantsById(id, true));//true表示已经visit过了
				}
	 ...
	 */
	private static final DBConnection connection = new MySQLDBConnection();//启动mongo 用MongoDBConnection()
