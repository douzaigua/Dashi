...
package yelp;
//从yelp获取数据，过滤数据，同时解决security数据，返回清理过的干净数据
...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "Mp5tkUJTMwIrHsWNxnkNYA";
	private static final String CLIENT_SECRET = "fm3LCa4yF5ZRA0adLDGvVYKFqfq4MHqxvXtQqULwRyS9KluPnd7vPlqEBNRwgxlq";
	...
	private JSONObject obtainAccessToken() {
		try {
			...
			connection.setRequestMethod("POST");//因为要产生新的token
